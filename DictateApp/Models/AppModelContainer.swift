...
enum AppModelContainer {
    ...
    private static let logger = Logger(
        subsystem: "com.gmalonso.dictate-mac",
    ...
    private static var appSupportURL: URL {
        FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
            .appendingPathComponent("com.gmalonso.dictate-mac", isDirectory: true)
    }
    ...
    private static func makeContainer() -> ModelContainer {
        ...
        let storeURL = appSupportURL.appendingPathComponent("DictateApp.store")
