...
enum AppConfig {
    static let appBundleId = "com.gmalonso.whisper-dictate-mac"
    ...
    static let urlScheme = "whisper-dictate-mac"

    // MARK: - Rate Limits

    static let freeHourlyLimit = 10_000
    static let proHourlyLimit = 10_000
    static let freeWeeklyLimit = 100_000
    static let proWeeklyLimit = 100_000
