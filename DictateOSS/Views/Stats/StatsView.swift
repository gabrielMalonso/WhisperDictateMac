...
struct StatsView: View {
    ...
    @AppStorage(MacAppKeys.localTotalDurationSeconds, store: .app)
    private var totalDurationSeconds: Double = 0

    @AppStorage(MacAppKeys.weeklyUsageCount, store: .app)
    private var weeklyUsed: Int = 0

    @AppStorage(MacAppKeys.weeklyUsageGoal, store: .app)
    private var weeklyGoal: Int = 0

    @AppStorage(MacAppKeys.weeklyUsageResetsAt, store: .app)
    ...
    private var effectiveWeeklyLimit: Int {
        weeklyGoal > 0 ? weeklyGoal : AppConfig.defaultWeeklyUsageGoal
    }
