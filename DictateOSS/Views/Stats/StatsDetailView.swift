...
struct StatsDetailView: View {
    ...
    @AppStorage(MacAppKeys.localTotalDictations, store: .app)
    private var localTotalDictations: Int = 0

    @AppStorage(MacAppKeys.localTotalWords, store: .app)
    private var localTotalWords: Int = 0

    @AppStorage(MacAppKeys.localCurrentStreak, store: .app)
    private var currentStreak: Int = 0

    @AppStorage(MacAppKeys.localLongestStreak, store: .app)
    private var longestStreak: Int = 0

    @AppStorage(MacAppKeys.localThisMonthDictations, store: .app)
    private var thisMonthDictations: Int = 0

    @AppStorage(MacAppKeys.localLast7DaysDictations, store: .app)
    private var last7DaysDictations: Int = 0

    @AppStorage(MacAppKeys.localBestDayDate, store: .app)
    private var bestDayDate: String = ""

    @AppStorage(MacAppKeys.localBestDayDictations, store: .app)
    private var bestDayDictations: Int = 0

    @AppStorage(MacAppKeys.localWeeklyChart, store: .app)
    ...
    private var totalCount: Int { localTotalDictations }
    private var totalWords: Int { localTotalWords }
