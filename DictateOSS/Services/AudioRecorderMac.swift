...
final class AudioRecorderMac: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.gmalonso.dictate-oss", category: "AudioRecorder")
...
private final class AudioCaptureCoordinator: NSObject, @unchecked Sendable {
    ...
    private let sessionQueue = DispatchQueue(label: "com.gmalonso.dictate-oss.audio-capture")
